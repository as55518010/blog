@extends('layouts.admin')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/article/'.$field->art_id.'')}}" role="form"  method="post"  enctype="multipart/form-data">
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>編輯：</th>
                        <td>
                            <input type="text" class="cate_order" name="art_editor" value="{{ $field->art_editor }}">
                        </td>
                    </tr>
                       ...
                       <input  type="file" name="art_thumb" id="file0" multiple="multiple"  /><br>
                             <img  width="125px" src="{{ $field->art_thumb }}"  id="img0" >
                        </td>
                        </tr>
                       ...
                       <tr>
                        ...
                        <td>
                            ...
                            <script id="editor" name="art_content" type="text/plain" style="width:860px;height:500px;">
                                <!-- 由於框架對於標籤極為敏感，所以需要以這種方式輸出 -->
                                {!! $field->art_content !!}</script>
